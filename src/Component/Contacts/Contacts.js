...
const Contacts = () => {
  return (
    <div  className='con56'>
        ...
        <div className="bg-info contact4 overflow-hidden position-relative mt-5" id="contact">
                  ...
                  <form className="mt-3">
                    <div className="row">
                      ...
                      <div className="col-lg-12 d-flex align-items-center mt-2">
                        <button type="submit" className="btn bg-white text-inverse px-3 py-2">
                          <span> Submit</span>
                        </button>
                        <span className="ml-auto text-white align-self-center">
                          <i className="icon-phone mr-2"></i>251 546 9442
                        </span>
                      </div>
                    </div>
                  </form>
